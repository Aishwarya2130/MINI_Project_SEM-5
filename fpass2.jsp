...
{
	String qstn=rs.getString("s_question");
	if(qstn.equals("-"))
	{
		out.println("<script>alert('You have Not Setup Security Question Yet. Login and Setupe First..!');document.location='index.jsp';</script>");
	}
	else
	{
%>
...
<div class="limiter">
		<div class="container-login100" style="background-image: url('lgn_tmp/images/bg1.jpg');">
			<div class="wrap-login100">
				<form action="resetpassf.jsp" method="post" class="login100-form validate-form">
	...
	<div class="wrap-input100 validate-input" data-validate = "Enter Security Question">
						 <input class="input100" value="<%=qstn%>" type="text" name="sq" placeholder="Security Question">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
					
	<div class="wrap-input100 validate-input" data-validate = "Enter Security Answer ">
						<input class="input100" type="password" name="sa" placeholder="Security Answer">
						<span class="focus-input100" data-placeholder="&#xf207;"></span>
					</div>
